...
public class DeviceController {
     ...
     */
    @GetMapping
    public Result<List<Device>> getDevices(@RequestAttribute("userId") Long userId) {
        try {
            if (userId == null) {
    ...
    public Result<Device> registerDevice(@RequestAttribute("userId") Long userId,
        ...
        try {
            ...
            Device device = deviceService.registerDevice(userId, deviceId, deviceName, userAgent, ipAddress);
